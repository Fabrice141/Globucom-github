...
export class CatalogComponent implements OnInit {
 ...
 activeTab:string = 't1';
  ...
  images = [
    {
      imageSrc: 'https://images.unsplash.com/photo-1667387322417-c434fa1f563d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDJ8NnNNVmpUTFNrZVF8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=60',
      imageAlt: 'naturel',
